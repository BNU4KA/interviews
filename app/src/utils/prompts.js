...
function buildSystemPrompt(promptParts, customPrompt = '', googleSearchEnabled = true, programmingLanguage = '', responseLanguage = '') {
    ...
    if (programmingLanguage) {
        additionalContext.push(`Programming language: ${programmingLanguage}`);
    }
    if (responseLanguage) {
        additionalContext.push(`Response language: ${responseLanguage}`);
    }
...
function getSystemPrompt(profile, customPrompt = '', googleSearchEnabled = true, programmingLanguage = '', responseLanguage = '') {
    const promptParts = profilePrompts[profile] || profilePrompts.interview;
    return buildSystemPrompt(promptParts, customPrompt, googleSearchEnabled, programmingLanguage, responseLanguage);
}
