...
export class AppHeader extends LitElement {
    ...
    async connectedCallback() {
        ...
        if (window.require) {
            ...
            try {
                const pid = await ipcRenderer.invoke('get-process-id');
                this.processId = pid;
                this.requestUpdate();
            } catch (error) {
    ...
    getViewTitle() {
        const processIdText = this.processId ? String(this.processId) : '';
        const titles = {
            onboarding: processIdText || 'Welcome to App',
            main: processIdText || 'App',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: processIdText || 'App',
        };
        return titles[this.currentView] || processIdText || 'App';
    }
