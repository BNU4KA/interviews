...
function getConfigDir() {
    ...
    if (platform === 'win32') {
        ...
        configDir = path.join(os.homedir(), 'AppData', 'Roaming', 'app-config');
    } else if (platform === 'darwin') {
        // macOS: ~/Library/Application Support/app-config
        configDir = path.join(os.homedir(), 'Library', 'Application Support', 'app-config');
    } else {
        // Linux and others: ~/.config/app-config
        configDir = path.join(os.homedir(), '.config', 'app-config');
    }
